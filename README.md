...
- GitHub auto-disables scheduled workflows after **60 days with no repo commits**. If you get the
  "workflow disabled" email, click **Enable** (or push any commit) to resume.
